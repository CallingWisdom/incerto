...
/**
 * FOL Predicate Not Equals, i.e., (x!=y)
 * @author Pedro Oliveira
 *
 */
public class PredicateNotEquals extends Predicate implements MLNElement, Cloneable{

	public PredicateNotEquals(Term t1, Term t2) {
		super("NotEquals", t1, t2);
	}
	...
	public Object clone()
	{
		return new PredicateNotEquals(this.terms.get(0), this.terms.get(1));
	}
